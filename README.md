...
- `content/authoring.md` and `content/offering-template/` are at the root of the menu as
  well, so the **Offerings** entry lists offerings only.
...
Use `content/offering-template/` as the starting point for a new offering:
